    ...
    <div className="self-stretch flex flex-col gap-4">
      ...
      <div className="w-full flex flex-col gap-0">
        ...
        {taskers.map((row, index) => (
          <div
            key={index}
            className="w-full py-4 border-0 border-b shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] grid grid-cols-[2fr_2fr_1fr_48px] items-center gap-4 group hover:bg-zinc-50 transition-colors" style={{ position: 'relative' }}
          >
