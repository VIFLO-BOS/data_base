...
export function MobileDrawer({ isOpen, onClose }: MobileDrawerProps) {
 ...
 {/* Drawer */}
 <div
 className={`fixed inset-y-0 left-0 z-50 w-72 max-w-[85vw] bg-white shadow-xl flex flex-col transform transition-transform duration-300 ease-in-out lg:hidden ${
 ...
 <div className="w-10 h-10 bg-indigo-600 rounded-xl inline-flex flex-col justify-center items-center shrink-0">
 ...
 {/* Nav Items */}
 <div className="flex-1 px-4 pt-6 flex flex-col justify-between overflow-y-auto">
 ...
 <div className="h-px bg-stone-900/20" />
 <LogoutButton />
 </div>
 </div>
 </div>
